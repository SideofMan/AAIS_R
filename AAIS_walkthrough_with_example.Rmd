...
if(Target_function=='outerproduct'){
  ...
  for(i in 1:7){
    ...
    p <- ggplot() + 
      ...
      labs(title = "AAIS algorithm compared to function", 
         x = "x", 
         y = "density") +
      scale_color_manual(name="",
                         labels = c("Algorithm output", "Function"),
                         values = c("red", "blue")) +
...
As we can see, the algorithm allows for sampling that is very representative of the target function. Below we can view some diagnostics plots of the algorithm.
